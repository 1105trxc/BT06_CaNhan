        ...
        <div className="row g-4 align-items-stretch">
            ...
            <div className="bg-white rounded-4 shadow-sm border p-4 text-center h-100">
              <div className="position-relative d-inline-block mb-3">
                ...
                <button 
                  ...
                  className="position-absolute bottom-0 end-0 text-white border-0 rounded-circle d-flex align-items-center justify-content-center shadow" 
                  style={{ width: '28px', height: '28px', background: 'var(--primary)' }}
                >
                  <i className="fa-solid fa-camera" style={{ fontSize: '10px' }}></i>
                </button>
              </div>
              <h5 className="fw-bold mb-1" style={{ color: 'var(--text-primary)' }}>{user?.full_name}</h5>
              ...
              <div className="list-group list-group-flush text-start border-top pt-3">
                ...
                <Link to="/orders" className="list-group-item list-group-item-action border-0 py-3 rounded-3 d-flex align-items-center gap-3 text-muted text-decoration-none">
          ...
          <main className="col-lg-8 col-xl-9">
            <div className="bg-white rounded-4 shadow-sm border p-4 p-md-5 h-100">
              <div className="mb-5">
                <h2 className="fw-bold h3 mb-2" style={{ color: 'var(--text-primary)' }}>Personal information</h2>
              ...
              <form onSubmit={onSubmit}>
                ...
                <div className="d-flex align-items-center justify-content-between pt-4 border-top">
                  ...
                  <button type="submit" disabled={isLoading} className="btn btn-purple px-5 py-2 fw-bold rounded-3 shadow-sm">
